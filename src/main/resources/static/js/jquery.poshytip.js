/*
 * Poshy Tip jQuery.poshytip plugin v1.2
		...
		refresh: function(async) {
			...
			if (bgImage) {
				...
				if (ie6 && bgImagePNG) {
					...
					this.$tip.prepend('<table class="tip-table" style="max-width:160px;" border="0" cellpadding="0" cellspacing="0"><tr><td class="tip-top tip-bg-image" colspan="2"><span></span></td><td class="tip-right tip-bg-image" rowspan="2"><span></span></td></tr><tr><td class="tip-left tip-bg-image" rowspan="2"><span></span></td><td></td></tr><tr><td class="tip-bottom tip-bg-image" colspan="2"><span></span></td></tr></table>')
