 ...
 * Version 1.0
 **/
public class UserNameToken extends UsernamePasswordToken implements Logger {
    // 序列化ID
    ...
    public UserNameToken(String username, String password, String captchaCode, String host) {
